...
describe("SimpleSolver", () => {
  it("Initial board with counts 1, 2, 3", () => {
    ...
    cells = [
      [8, 1, 1, 8, 1, 0, 1, 1, 8, 8, 8, 8, 8],
      [8, 2, 2, 1, 1, 0, 2, 8, 8, 8, 8, 8, 8],
      [8, 8, 1, 0, 0, 0, 3, 8, 8, 8, 8, 8, 8],
      [8, 1, 1, 0, 0, 0, 2, 8, 8, 4, 8, 8, 8],
      [8, 1, 1, 1, 0, 0, 1, 2, 2, 2, 8, 8, 8],
      [8, 2, 8, 2, 0, 0, 0, 0, 1, 1, 8, 8, 8],
      [8, 8, 8, 3, 1, 0, 0, 0, 1, 8, 8, 8, 8],
      [8, 8, 2, 8, 1, 0, 0, 0, 1, 2, 8, 8, 8],
      [8, 8, 8, 3, 2, 1, 0, 0, 0, 2, 8, 8, 8],
      [8, 8, 8, 3, 8, 1, 1, 1, 1, 2, 8, 8, 8],
      [8, 8, 8, 8, 2, 2, 2, 8, 1, 2, 8, 8, 8],
      [8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8],
      [8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8],
    ];
